  ...
  es: {
    translations: {
      ...
      tagModal: {
        ...
        success: "Tag Guardado exitosamente.",
      },
      chat: {
      ...
      schedules: {
        ...
        toasts: {
          deleted: "Programación eliminado con éxito.",
        }
      },
      scheduleModal: {
        title: {
	  ...
	  bots: {
        ...
        hierarchy: {
          title: "Fluxograma do SEU Chatbot"
        }
      },
      queueSelect: {
        inputLabel: "Sectores",
